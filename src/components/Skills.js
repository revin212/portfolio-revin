...
export default function Skills() {
  return (
    <div id='skills' className='skills-section w-full bg-main-black px-[1.2rem] lg:px-[2rem] py-[4rem]'>
        <div className="skills-content max-w-[1132px] mx-auto">
            ...
            <div className="skills-list bg-gradient-black bg-cover bg-right-bottom bg-no-repeat p-4 rounded-lg lg:flex lg:justify-between">
              <div className="front-end mb-[3rem] lg:mb-4 lg:w-[30%]">
              ...
              <div className="back-end mb-[3rem] lg:mb-4 lg:w-[30%]">
              ...
              <div className="other-stack mb-[3rem] lg:mb-4 lg:w-[30%]">
